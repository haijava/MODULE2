package hai.provinces.AppConfig;
import hai.provinces.fomatter.ProvinceFomatter;
import hai.provinces.services.CustomerService;
import hai.provinces.services.ProvinceService;
import hai.provinces.services.impl.CustomerServicesImpl;
import hai.provinces.services.impl.ProvinceServiceImpl;
...
@EnableJpaRepositories("hai.provinces.repository")
@ComponentScan("hai.provinces")
public class ApplicationConfig extends WebMvcConfigurerAdapter implements ApplicationContextAware {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[]{"hai.provinces.model"});
